    ...
    <div class="px-5 py-3 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div class="text-xs text-amber-900">
            ...
            @elseif($status === 'approved')
                This budget proposal is finalized and cannot be modified.
            @else
                Saving will store this budget as a draft. 
...
<div id="resubmitModal"
    ...
    <div class="bg-white w-full max-w-md rounded-xl shadow-lg p-6">
        ...
        <p class="text-xs text-slate-600 mb-4">
            Resubmitting this budget proposal will remove existing approvals. 
            Reviewers will need to approve this document again.
        </p>
...
<div id="returnModal"
    ...
    <div class="bg-white w-full max-w-md rounded-xl shadow-lg p-6">
        ...
        <p class="text-xs text-slate-600 mb-4">
            Please provide remarks explaining why this budget is being returned.
        </p>
