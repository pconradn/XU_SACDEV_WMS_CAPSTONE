...
@if($status === 'submitted')
Editing and resubmitting will reset previous approvals.
...
Resubmitting this form will remove existing approvals.
...
<form method="POST"
action="{{ route('org.projects.ticket-selling-report.approve', $project) }}">
...
: route('org.projects.ticket-selling-report.return', $project) }}">
...
<p>
Submitting this Ticket Selling Report will forward it for approval through the SACDEV workflow.
</p>
