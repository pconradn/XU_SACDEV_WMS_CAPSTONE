...
<th class="border border-slate-300 px-2 py-1 w-[100px]">
Quantity
</th>
...
<td class="border border-slate-300">
<input type="number" name="items[0][quantity]" oninput="updateSubtotal(this)" class="w-full px-2 py-1 border-0 text-[12px]" @if($isReadOnly || $isAdmin) disabled @endif>
</td>

<td class="border border-slate-300">
<input type="text" name="items[0][particulars]" class="w-full px-2 py-1 border-0 text-[12px]" @if($isReadOnly || $isAdmin) disabled @endif>
</td>

<td class="border border-slate-300">
<input type="number" step="0.01" name="items[0][selling_price]" oninput="updateSubtotal(this)" class="w-full px-2 py-1 border-0 text-[12px]" @if($isReadOnly || $isAdmin) disabled @endif>
</td>
