        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-4 space-y-3">
                ...
                <div id="objectivesWrap" class="space-y-2">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 sm:items-center objective-row dynamic-row">

                        <textarea
                            name="objectives[]"
                            class="w-full min-w-0 rounded-lg border px-3 py-2 text-xs resize-none
                        ...
                        <button type="button"
                            class="remove-btn shrink-0 self-end sm:self-auto text-slate-400 hover:text-rose-600 text-sm px-2">
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-4 space-y-3">
                ...
                <div id="indicatorsWrap" class="space-y-2">
                    @foreach($indicators as $ind)
                        <div class="flex flex-col sm:flex-row gap-2 sm:items-center indicator-row dynamic-row">
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-4 space-y-3">
                ...
                <div id="partnersWrap" class="space-y-2">
                    @foreach($partners as $partner)
                        <div class="flex flex-col sm:flex-row gap-2 sm:items-center partner-row dynamic-row">
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-4 space-y-3">
                ...
                <div id="rolesWrap" class="space-y-2">
                    @foreach($roles as $role)
                        <div class="flex flex-col sm:flex-row gap-2 sm:items-center role-row dynamic-row">
