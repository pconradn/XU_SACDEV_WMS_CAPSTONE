<div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm mb-4">
    ...
    <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
            <label class="text-sm font-medium text-slate-700">Course & Year</label>
            <input type="text" name="course_and_year"
                   ...
                   {{ $isLocked ? 'disabled' : '' }}>
            @error('course_and_year') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
        </div>
        ...
        <div>
            <label class="text-sm font-medium text-slate-700">Age (optional)</label>
