...
<form method="POST"
action="{{ route('org.projects.fees-collection.approve', $project) }}">
...
: route('org.projects.fees-collection.return', $project) }}">
...
<p>
Submitting this report will forward it for approval to the
...
@if($isAdmin)
@include('org.projects.documents.fees-collection.partials._approve-modal')
@endif