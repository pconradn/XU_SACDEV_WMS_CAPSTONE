        ...
        <table class="min-w-full text-xs">
            ...
            <thead class="text-[11px] uppercase text-slate-500 border-b border-slate-200 bg-white">
                <tr>
                    ...
                    <th class="py-2.5 px-4 font-medium">Organizer</th>
                    <th class="py-2.5 px-4 font-medium">Venue</th>
                    <th class="py-2.5 px-4 font-medium">From</th>
                    <th class="py-2.5 px-4 font-medium text-right">To</th>
                </tr>
            </thead>
