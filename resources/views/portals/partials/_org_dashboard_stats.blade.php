<div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
    ...
    {{-- Pending Tasks (Error / Rose) --}}
    <div class="relative rounded-2xl border border-rose-200 bg-gradient-to-b from-rose-50 to-white shadow-sm p-4">
    ...
    {{-- Assigned Projects (Info / Blue) --}}
    <div class="relative rounded-2xl border border-blue-200 bg-gradient-to-b from-blue-50 to-white shadow-sm p-4">
    ...
    {{-- Organization Projects (Neutral / Indigo hint) --}}
    <div class="relative rounded-2xl border border-indigo-200 bg-gradient-to-b from-indigo-50 to-white shadow-sm p-4">
    ...
    {{-- Project Documents (Success / Emerald) --}}
    <div class="relative rounded-2xl border border-emerald-200 bg-gradient-to-b from-emerald-50 to-white shadow-sm p-4">
