...
<form method="POST"
action="{{ route('org.projects.selling-activity-report.approve', $project) }}">
...
: route('org.projects.selling-activity-report.return', $project) }}">
...
<p>
Submitting this Selling Activity Report will forward it for approval to the
