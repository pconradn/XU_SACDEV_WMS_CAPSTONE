...
$clusterColors = [
    ...
    3 => 'bg-amber-100 text-amber-700 border-amber-200',       // Food and Agriculture
    4 => 'bg-purple-100 text-purple-700 border-purple-200',    // Governance and Policy-Making
    5 => 'bg-pink-100 text-pink-700 border-pink-200',          // Media and Arts
    6 => 'bg-indigo-100 text-indigo-700 border-indigo-200',    // Engineering
    7 => 'bg-emerald-100 text-emerald-700 border-emerald-200', // BIOPHILIC
    8 => 'bg-cyan-100 text-cyan-700 border-cyan-200',          // CHEMSOC
    9 => 'bg-yellow-100 text-yellow-700 border-yellow-200',    // GDSC
    10 => 'bg-rose-100 text-rose-700 border-rose-200',         // AISSA
    11 => 'bg-orange-100 text-orange-700 border-orange-200',   // EXCEL
    12 => 'bg-lime-100 text-lime-700 border-lime-200',         // XCITES
    13 => 'bg-sky-100 text-sky-700 border-sky-200',            // Program-based
    14 => 'bg-teal-100 text-teal-700 border-teal-200',         // Service-learning
    15 => 'bg-fuchsia-100 text-fuchsia-700 border-fuchsia-200',// Socio-cultural
    16 => 'bg-red-100 text-red-700 border-red-200',            // Sports and Recreation
    17 => 'bg-slate-100 text-slate-700 border-slate-200',      // Professional Organizations
];
@endphp

<div x-data="organizationModal()">
