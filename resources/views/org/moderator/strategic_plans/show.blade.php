            ...
            <div class="rounded-xl border border-indigo-200 bg-indigo-50 p-5">
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-2 text-sm text-indigo-900 whitespace-pre-line">
                            {{ $submission->sacdev_remarks }}
                        </div>

                        @if(!empty($submission->sacdev_reviewed_by))
                            <div class="mt-2 text-xs text-indigo-700">
                                Reviewed by User ID: {{ $submission->sacdev_reviewed_by }}
                            </div>
                        @endif
                    </div>
                </div>
