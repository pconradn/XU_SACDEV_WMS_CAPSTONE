<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    ...
    <div class="md:col-span-2 bg-white shadow-sm rounded-2xl border border-slate-200 p-5">
        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Basic identity, mission, and vision submitted in the Strategic Plan.
                </p>
            </div>
        ...
        {{-- Mission + Vision (balanced, easy scan) --}}
    ...
    <div class="bg-white shadow-sm rounded-2xl border border-slate-200 p-5">
        ...
        @else
            <div class="mt-4 rounded-xl border border-dashed border-slate-200 bg-slate-50 p-6 text-center">
                <div class="text-sm font-semibold text-slate-800">No logo uploaded</div>
                <div class="mt-1 text-sm text-slate-600">
                    The organization didn’t include a logo in this submission.
                </div>
            </div>
        @endif
    </div>
