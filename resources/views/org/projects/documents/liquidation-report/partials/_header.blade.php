...
<div class="relative overflow-hidden rounded-2xl border border-slate-200 shadow-sm">
    ...
    <div class="relative px-5 py-6 flex flex-col items-center text-center gap-2">
        ...
        <div class="mt-3 grid grid-cols-1 md:grid-cols-3 gap-3 w-full text-center">
        ...
        <div class="mt-3 grid grid-cols-1 md:grid-cols-2 gap-3 w-full text-center items-start">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input
                        ...
                        class="w-full md:w-[220px] mx-auto text-center rounded-lg px-3 py-2 text-xs border
