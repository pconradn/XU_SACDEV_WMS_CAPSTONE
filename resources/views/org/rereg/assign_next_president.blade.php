    ...
    <div class="mx-auto max-w-3xl px-4 py-6">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <form method="POST" action="{{ route('org.provision.next_president.store') }}"
                  onsubmit="return confirm('Assigning will create/assign an account for this person for the target school year. Continue?');">
                @csrf
                ...
                <div class="mt-4 flex flex-col gap-2 sm:flex-row">
                    <button class="inline-flex justify-center rounded-lg bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800">
                        Assign President for Target SY
                    </button>
